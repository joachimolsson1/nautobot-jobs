...
from nautobot.extras.models import Status, Role, Secret, Tag, CustomField
...
class FetchAndAddExtremeCloudIQDevices(Job):
    ...
    def run(self):
        ...
        for tenant_name in tenants:
            ...
            secret_apikey = Secret.objects.get(name=f"{tenant_name_string} Extreme Cloud iQ").get_value()
